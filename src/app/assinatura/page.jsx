'use client';
import {Section, Content, ContentDefault, Container, Wrapper, Badge, Grid, Divider} from '@/lib/modules/layout-components';
import {Button, Collapsible, List} from '@/lib/modules/ui-components';
import {scrollToTop, list, url} from '@/lib/modules/utils';
import Carousel from '@/lib/modules/carousel';
import Pagamento from '@/lib/modules/pagamento';
...
export default function Home() {
    ...
    return (
        <main>
                ...
                <Content className='relative z-10 w-full'>
                    <ContentDefault>
                        <Wrapper className='justify-center' id='header-box'>
                            <Container className='items-center w-[65%] max-[820px]:!w-[96%] max-[426px]:w-full max-w-[820px]'>
                                ...
                                <p className='text-2xl text-center my-4'>
                                    <strong>Seja referência em palmilhas na sua cidade, atenda seus pacientes com segurança e tenha um consultório realmente lucrativo</strong>
                                </p>
                                <p className='text-center mb-8'>
                                    Um programa desenvolvido para facilitar o seu dia a dia clínico através de conteúdos teóricos e aulas práticas com materiais enviados mensalmente até a sua casa - <strong>sem nenhum custo adicional</strong>.
                                </p>
            ...
            <Section id='saiba-mais' className='relative z-20 bg-slate-100 cor-4 pb-16 pt-0 max-[1024px]:pb-0'>
                <Content>
                    <ContentDefault>
                ...
                <Content className='bg-[#092b3f] relative z-20 mt-64 max-[820px]:!pb-16'>
                    <ContentDefault>
                        ...
                        <Container className='items-center justify-center relative pt-16 text-white'>
                            ...
                            <Grid className='grid-cols-2 max-[820px]:!grid-cols-1 gap-16 w-9/12 max-[820px]:!w-full max-[820px]:!gap-2'>
                                ...
                                <div className='flex flex-col justify-center max-[820px]:!text-center'>
                                    <h2 className='text-2xl font-semibold my-2 grad-text'>Comunidade <mark className="text-sky-600">ativa</mark> de membros</h2>
                            ...
                            <Grid className='grid-cols-2 max-[820px]:!grid-cols-1 gap-16 w-9/12 max-[820px]:!w-full max-[820px]:!gap-2'>
                                ...
                                <div className='flex flex-col justify-center max-[820px]:!text-center'>
                                    <h2 className='text-2xl font-semibold my-2 grad-text'>Vantagens de compra de produtos e <mark className="text-sky-600">frete grátis</mark> durante todo o curso</h2>
                    ...
                    <img id='tab-2' className='absolute w-screen scale-x-[-1] bottom-0 translate-y-full z-20' src={ASSET_PREFIX + 'img/svg/tab.svg'} alt='' draggable='false' />
                </Content>
            </Section>
                            ...
                            <Wrapper className='max-[820px]:!flex-col items-center justify-evenly relative bottom-6 max-[820px]:!bottom-0'>
                                ...
                                <Container className='items-start'>
                                    <Grid className='grid-cols-2 max-[820px]:!grid-cols-1'>
                                        <Container className='basis-[100%] mx-8 max-[820px]:!mx-0 px-4 self-center'>
                                            ...
                                            <List className='chain mx-auto max-w-[480px] my-8'>
                                                <li>Profissionais que desejam <strong className='grad-text grad-slide'>proporcionar um tratamento mais eficiente</strong> para os seus pacientes.</li>
                                                <li>Clínicos que buscam <strong className='grad-text grad-slide'>conciliar a prática clínica com seus negócios</strong>.</li>
                                                <li><strong className='grad-text grad-slide'>Empreendedores</strong> que visam a utilizar a confecção e prescrição de palmilhas como um <strong className='grad-text grad-slide'>modelo de negócio rentável</strong>, fazendo delas o <strong className='grad-text grad-slide'>carro-chefe</strong> do consultório.</li>
                                            </List>
                                        </Container>
                                        <Container>
            ...
            <Section id='podoshop-clube' className='pt-0 bg-[var(--cor-4)] border-y-[.5rem] border-[var(--cor-1)]'>
                ...
                <Content>
                    <ContentDefault className='pt-16 relative z-10'>
                        <Grid className='grid-cols-2 max-[820px]:!grid-cols-1 gap-8'>
                            <Container className="w-full self-center" id="kit-exclusivo">
                                <h1 className="grad-text text-3xl font-bold">KIT EXCLUSIVO PODOSHOP®</h1>
                                <br />
                                <p>
                                    Cada aluno do Palmilhando receberá um kit mensalmente, <mark className="text-sky-400">sem custo adicional</mark>, para colocar em prática todo o aprendizado e fazer as suas próprias palmilhas.
                                    <br /><br />
                                    <img src={ASSET_PREFIX + 'img/kit-exclusivo.webp'} alt='' draggable='false' className='m-auto h-auto my-4 w-full min-[821px]:hidden relative bottom-12' />
                                </p>
                                <p>
                                    No período de um ano, você poderá fazer 24 palmilhas com o material disponibilizado e <mark className="text-sky-400">recuperar todo o seu investimento no curso</mark>.
                                    Além disso, você terá <mark className="text-sky-400">descontos</mark> em todos os produtos e <mark className="text-sky-400">frete grátis</mark> para economizar de verdade.
                                    <br /><br />
                            ...
                            <Container className='w-full max-[820px]:!hidden m-4'>
            ...
            <Section id='palmilhando-pbe'>
                <Content>
                    <ContentDefault>
                        <Grid className='grid-cols-2 max-[820px]:!grid-cols-1'>
                            <Container className='w-full self-center'>
                            ...
                            <Container className='w-9/12 justify-self-center self-center m-4 backlit'>
                                <img src={ASSET_PREFIX + 'img/png/pbe_venn.png'} alt='' draggable='false' className='m-auto w-full h-auto my-4' />
                            </Container>
                        </Grid>
                    </ContentDefault>
                </Content>
                ...
                <Content className='border-[2px] border-white px-8 max-[820px]:!px-0'>
                    <ContentDefault>
                        <Wrapper className='items-end justify-evenly py-8'>
                            <Container className='w-1/2 max-[820px]:!w-[96%] max-[426px]:w-full px-4'>
                                <h1 className='text-sky-600 text-3xl font-bold'>Com o Palmilhando® você vai:</h1>
                                <Divider color='var(--cor-7)' className='my-4' position={isMobile ? 'center' : 'left'} />
                                <br />
                            ...
                            <Container className='w-1/2 max-[820px]:!w-[80%] max-[426px]:w-full relative'>
                                ...
                                <Checkout className='relative z-50 max-[820px]:!mt-8' />
                            </Container>
                        </Wrapper>
                    </ContentDefault>
                </Content>
                ...
                <Content>
                    <ContentDefault>
                        <Container className='w-full max-w-[48rem] mx-auto cor-4'>
                            <h1 className='text-xl font-bold my-4'>Garantia incondicional de 7 dias.</h1>
            ...
            <Section id='criadores' className='overflow-hidden border-t-2 border-cyan-100'>
                <Content className='relative z-10'>
                    <ContentDefault>
                        <h1 className='text-center font-bold text-xl'>Conheça os criadores do <mark className="cor-2">Palmilhando</mark>!</h1>
                        <Wrapper className='justify-center pt-32'>
                            <Container className='relative w-[40%] max-[820px]:!w-full max-[820px]:!mb-32 p-8 pt-28 border-2 border-cyan-100 bg-[var(--cor-1-5)] grad-light rounded-lg shadow-md mx-4 max-[820px]:!mx-0'>
                                ...
                                ></div>
                                <h2 className='text-center font-bold text-xl'>André Mendes</h2>
                                <div className="divider"></div>
                            ...
                            <Container className='relative w-[40%] max-[820px]:!w-full p-8 pt-28 border-2 border-cyan-100 bg-[var(--cor-1-5)] grad-light rounded-lg shadow-md mx-4 max-[820px]:!mx-0'>
                                ...
                                ></div>
                                <h2 className='text-center font-bold text-xl'>Clayton Fuzetti</h2>
                                <div className="divider"></div>
                                <List className='check-light pt-4 mx-auto'>
                                    <li>Fisioterapeuta</li>
                    ...
                    <Content>
                        <ContentDefault className='flex justify-evenly max-[820px]:!flex-col'>
                            <Container className='w-[30%] max-[820px]:!w-[90%] max-[820px]:!mx-auto max-[820px]:!mb-8 max-[820px]:!text-center'>
                                <h2 className='font-bold text-xl'>Ficou com alguma dúvida?</h2>
                                <div className="divider left"></div>
